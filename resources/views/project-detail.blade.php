...
<body class="bg-white antialiased min-h-screen flex flex-col">
    ...
    <x-navbar variant="light" layout="relative" :loggedIn="true" />

    <main class="flex-grow w-full pb-0">
            ...
            <div class="relative w-full h-[400px] md:h-[500px] rounded-[32px] overflow-hidden shadow-lg group">
                ...
                <div class="absolute bottom-0 left-0 w-full p-8 md:p-12 flex flex-col md:flex-row justify-between items-end gap-6">
                    ...
                    <button class="bg-[#0d8276] hover:bg-[#0a6b61] text-white px-8 py-3.5 rounded-full font-bold flex items-center gap-2 transition shadow-lg shadow-teal-500/30 whitespace-nowrap">
                        Visit Website <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-16 mb-24">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col items-center text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-8 leading-relaxed">Exploring the intersection of creative coding and accessible user interfaces. Currently focusing on WebGL experiences and design systems.</p>
                        <a href="/profile" class="block w-full text-center bg-[#bfdbfe] hover:bg-[#93c5fd] text-[#1e3a8a] font-bold py-3 rounded-xl transition-colors">View Profile</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-[24px] p-4 shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group flex flex-col">
                        <div class="overflow-hidden rounded-xl mb-4 h-48 bg-gray-900">
                            <img src="https://placehold.co/600x400/{{ $i % 2 == 0 ? '1e293b' : '0f172a' }}/white" alt="Project" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        </div>
                        <div class="flex items-center gap-2 mb-3 px-2">
                            <img src="https://ui-avatars.com/api/?name=Author&background=random&color=fff" alt="Avatar" class="w-6 h-6 rounded-full">
                            <span class="text-xs font-semibold text-gray-600">Author Name</span>
                        </div>
                        <h3 class="text-lg font-bold text-gray-900 mb-2 px-2">Project Title</h3>
                        <p class="text-sm text-gray-500 mb-6 line-clamp-2 px-2 flex-grow">A brief description of this interesting project.</p>
                        <a href="#" class="flex items-center justify-center gap-2 w-full bg-[#f1f5f9] hover:bg-gray-200 text-gray-800 font-semibold py-3.5 rounded-xl text-sm transition mt-auto">
                            View Website <svg class="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                        </a>
                    </div>
                    @endfor
                </div>
